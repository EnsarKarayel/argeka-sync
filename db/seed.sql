...
values
  ...
  ('33333333-3333-4333-8333-333333333332', '11111111-1111-4111-8111-111111111111', 'business_development', 'Ä°ÅŸ geliÅŸtirme', 'own', '{"forecast","probability"}', '{"opportunities":true,"meetings":true}'),
  ('33333333-3333-4333-8333-333333333333', '11111111-1111-4111-8111-111111111111', 'sales_operations', 'SatÄ±ÅŸ operasyon', 'team', '{"note"}', '{"opportunities":true,"meetings":true,"export":true}'),
...
values
  ('44444444-4444-4444-8444-444444444441', '11111111-1111-4111-8111-111111111111', 'Ä°ÅŸ GeliÅŸtirme'),
  ('44444444-4444-4444-8444-444444444442', '11111111-1111-4111-8111-111111111111', 'SatÄ±ÅŸ Operasyon'),
...
values
  ...
  ('55555555-5555-4555-8555-555555555552', '11111111-1111-4111-8111-111111111111', 'Atlas Lojistik', 'Lojistik', 'TR Ä°Ã§ Anadolu')
on conflict (id) do nothing;

insert into contacts (id, tenant_id, account_id, full_name, email, phone)
values
  ('66666666-6666-4666-8666-666666666661', '11111111-1111-4111-8111-111111111111', '55555555-5555-4555-8555-555555555551', 'AyÅŸe YÄ±lmaz', 'ayse@novatek.example', '+90 212 000 00 01'),
...
values
  ('11111111-1111-4111-8111-111111111111', '55555555-5555-4555-8555-555555555551', '66666666-6666-4666-8666-666666666661', '22222222-2222-4222-8222-222222222222', 'ARG-2026-0001', 'Nova Teknoloji CRM baÅŸlangÄ±Ã§ paketi', 'sent', 84000, 0, 16800, 100800, '2026-05-31', 'Demo sonrasÄ± yÄ±llÄ±k lisans teklifidir.')
